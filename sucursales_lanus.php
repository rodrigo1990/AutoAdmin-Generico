  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/lanus.jpg" alt="LANUS" class="img_full" />
                <span>LANUS</span><br />
                9 de Julio 1140, Local 5, Galería de las Américas
                <br /><br />
                <b>TEL:</b> 4240-4798 / 5448<br />
                <b>Whatsapp:</b> 15 3252 4303
                <br /><br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.708119, lng: -58.389905};
