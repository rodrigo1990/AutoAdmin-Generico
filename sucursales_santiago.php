  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/santiago.jpg" alt="SANTIAGO DEL ESTERO" class="img_full" />
                <span>SANTIAGO DEL ESTERO</span><br />
                Tucumán 296
                <br /><br />
                <b>TEL:</b> 0385-422-2206 / 0385-699-3499
                <br /><br />
                Lunes a Viernes de 8 a 12 y 17 a 21hs<br />
...
<script>
  function initMap() {
    var uluru = {lat: -27.783879, lng: -64.262519};
