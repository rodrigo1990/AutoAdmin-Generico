...
<br />
<div style="text-align: center; background: #0070B7;">
	<br />
	<img src="imagenes/creditos/tarjeta.png" alt="SOLICITA TU CREDITO!! es fácil para vos" />
	<br /><br />
	<?php
        if  (($_POST['nombre']) && ($_POST['apellido']) && ($_POST['mail']) && ($_POST['telefono']))
        {
            ...
            $mail->Send();
             ...
             echo "<div style=\"clear:both; color: red; line-height:200px; text-align:center; \">El  formulario se ha enviado correctamente.</div>";
        }
        else 
        {
            if($_POST['submit'])
            {
                echo "<div style=\"position: absolute; margin: 790px 0px 0px 480px; color: red;font-size: 14px;\">Por favor, completá todos los campos.</div>";
            }
            ?>
            <form action="?s=solicitud_credito" method=post enctype="multipart/form-data">
