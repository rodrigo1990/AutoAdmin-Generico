<div id="contiene_contacto">
	...
	<div id="izquierda_contacto">
		...
		$captcha_publickey = "6LfEEuoSAAAAAGa0tmuvHyb0RVt2QBvJtMtCcWCE";
		$captcha_privatekey = "6LfEEuoSAAAAABxyTuGTyRc9ZgTd19JXam_M-vVd";
		$error_captcha=null;
				...
				if  (($_POST['nombre']) && ($_POST['mail']) && ($_POST['telefono']))
        {
			...
			*/
            ...
            $cuerpo2 = "GRACIAS POR ELEGIRNOS, ESTAMOS PROCESANDO SU SOLICITUD. NOS PONDREMOS EN CONTACTO ENTRE LAS 10:00 Y LAS 13:00.<br>ARGENPESOS";
        ...
        else 
        {
			...
			<br /><br />
            <form action="?s=contacto3" method=post>
			...
			else
			{
				...
				echo "Por favor, escribí el código de validación correctamente.";
