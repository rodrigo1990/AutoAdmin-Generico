...
<br />
<div style="text-align: center; background: #FFEC00;">
	<br />
	<img src="imagenes/creditos/monotributista.png" alt="SOLICITA TU CREDITO!! es fácil para vos" />
	<br /><br />
	<?php
				if  (($_POST['prestamo']) && ($_POST['nombre']) && ($_POST['dni']) && ($_POST['telefono']) && ($_POST['email']))
				{
		            ...
		            $mail2->Subject = "Solicitud crédito - Crédito Monotributista";
					...
					$mail->Subject = "Solicitud crédito - Monotributista";
				...
				{
					//echo "<div style=\"position: absolute; margin: 1005px 0px 0px 375px; color: #FF2B00; font-size: 12px; \">Por favor, complet&aacute; todos los campos.</div>";
							
					?>
					<form action="?s=solicitud_credito_monotributista" method=post>
