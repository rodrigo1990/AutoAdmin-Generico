...
<br />
<div style="text-align: center; background: #4D2581;">
	<br />
	<img src="imagenes/creditos/cuota.png" alt="SOLICITA TU CREDITO!! es fácil para vos" />
	<br /><br />
	<?php
				if  (($_POST['prestamo']) && ($_POST['nombre']) && ($_POST['dni']) && ($_POST['telefono']) && ($_POST['email']))
				{
		            ...
		            $mail2->Subject = "Solicitud crédito - Crédito Cuota";
					...
					$mail->Subject = "Solicitud crédito - Crédito Cuota";
				...
				{
					//echo "<div style=\"position: absolute; margin: 1010px 0px 0px 375px; color: #cccccc; font-size: 12px; \">Por favor, complet&aacute; todos los campos.</div>";
							
					?>
					<form action="?s=solicitud_credito_cuota" method=post>
					<table id="tabla_contacto_nuevo" style="color: #ffffff;" >
						<tr> 
							<td>
								<br /><br />
