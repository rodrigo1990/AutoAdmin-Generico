...
<br />
<div style="text-align: center; background: #008BC8;">
	<br />
	<img src="imagenes/creditos/vale.png" alt="SOLICITA TU CREDITO!! es fácil para vos" />
	<br /><br />
	<?php
				if  (($_POST['prestamo']) && ($_POST['nombre']) && ($_POST['dni']) && ($_POST['telefono']) && ($_POST['email']))
				{
		            ...
		            $mail2->Subject = "Solicitud crédito - Crédito Vale";
					...
					$mail->Subject = "Solicitud crédito - Crédito Vale";
				...
				{
					echo "<div style=\"position: absolute; margin: 1050px 0px 0px 375px; color: #cccccc; font-size: 12px; \">Por favor, complet&aacute; todos los campos.</div>";
							
					?>
					<form action="?s=solicitud_credito_vale" method=post>
