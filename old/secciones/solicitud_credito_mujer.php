...
<br />
<div style="text-align: center; background: #DF007A;">
	<br />
	<img src="imagenes/creditos/mujer.png" alt="SOLICITA TU CREDITO!! es fácil para vos" />
	<br /><br />
	<?php
				if  (($_POST['prestamo']) && ($_POST['nombre']) && ($_POST['dni']) && ($_POST['telefono']) && ($_POST['email']))
				{
		            ...
		            $mail2->Subject = "Solicitud crédito - Crédito Mujer";
					...
					$mail->Subject = "Solicitud crédito - Crédito Mujer";
				...
				else 
				{
					...
					?>
					<form action="?s=solicitud_credito_mujer" method=post>
