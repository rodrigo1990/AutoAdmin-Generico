...
function __construct() {
	...
	// Create the widget
	parent::__construct( 'mts_ad_widget', sprintf( __('%s125x125 Ads', 'sociallyviral' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => __( 'Our Sponsors', 'sociallyviral' ),
