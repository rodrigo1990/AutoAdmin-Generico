  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/lomas.jpg" alt="LOMAS DE ZAMORA" class="img_full" />
                <span>LOMAS DE ZAMORA</span><br />
                Av. Meeks 99
                <br /><br />
                <b>TEL:</b> 4244-1120 / 4243-1456<br />
                <b>Whatsapp:</b> 15 3252 4297
                <br /><br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.762114, lng: -58.398490};
