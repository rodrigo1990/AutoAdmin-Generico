  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/solano.jpg" alt="SOLANO" class="img_full" />
                <span>SOLANO</span><br />
                Calle 845 Nº2590
                <br /><br />
                <b>TEL:</b> 4212-6770 / 7174<br />
                <b>Whatsapp:</b> 15 3252 5078
                <br /><br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.781893, lng: -58.313348};
