  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/varela.jpg" alt="VARELA" class="img_full" />
                <span>VARELA</span><br />
                Monteagudo 345 
                <br /><br />
                <b>TEL:</b> 4287-8544 / 8567<br />
                <b>Whatsapp:</b> 15 3252 4920
                <br /><br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.804170, lng: -58.274902};
