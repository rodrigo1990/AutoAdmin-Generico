  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/avellaneda.jpg" alt="AVELLANEDA" class="img_full" />
                <span>AVELLANEDA</span><br />
                Av. Mitre 531
                <br /><br />
                <b>TEL:</b> 4201-5784 / 6561<br />
                <b>Whatsapp:</b> 15 3252 5817
                <br /><br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.660564, lng: -58.367637};
