  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/sanmiguel1.jpg" alt="SAN MIGUEL" class="img_full" />
                <span>SAN MIGUEL</span><br />
                Av. Mitre 1302
                <br /><br />
                <b>TEL:</b> 4451-5925 / 5787<br />
                <b>Whatsapp:</b> 15 3252 2982
                <br /><br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.546331, lng: -58.716662};
