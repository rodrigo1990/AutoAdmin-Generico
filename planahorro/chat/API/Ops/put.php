<?php
					...
					$email )
	{
		...
		if ( isset( $operator["opID"] ) )
			...
			$query = "REPLACE INTO p_operators VALUES ( $opid, 0, 0, 0, 0, $rate, $op2op, $traffic, $viewip, 1, $maxc, 0, '', '', 0, $sms, '', '$login', '$password', '$name', '$email', '', 'default', 'default', 'default' )" ;
					...
					$opid )
	{
		...
		$query = "INSERT INTO p_op_vars VALUES( $opid, 1, 0, 0, 0, 1 )" ;
		database_mysql_query( $dbh, $query ) ;
