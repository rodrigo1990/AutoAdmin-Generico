<?php
					...
					$sim_ops = "" )
	{
		...
		else
		{
			...
			$query = "INSERT INTO p_requests VALUES ( NULL, $now, 0, 0, $now, $vupdated, $status, $auto_pop, $initiate, $deptid, $opid, $op2op, $t_vses, $marketid, $os, $browser, $requests, '$ces', '$resolution', '$vname', '$vemail', '$ip', '$vis_token', '$vis_token_', '$sim_ops', '', '$onpage', '$title', '$rstring', '$refer', '$custom', '$question' )" ;
