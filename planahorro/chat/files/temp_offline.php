...
<div style="padding: 10px;">
	...
	<tr>
		<td width="100%"><div style="font-size: 18px; font-weight: bold; color: #FD7D7F;">Service Temporarily Unavailable</div></td>
		<td width="16"><?php if ( $embed ): ?><img src="../pics/icons/close.png" width="16" height="16" border="0" alt=""><?php endif ; ?></td>
	</tr>
	</table>
	<div style="margin-top: 10px;">Service is temporarily unavailable.  Please try back at a later time.  Thank you for your patience.</div>
