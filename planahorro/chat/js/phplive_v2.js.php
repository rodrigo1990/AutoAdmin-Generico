<?php
	...
	$popout_div = ( !isset( $VALS["POPOUT"] ) || ( $VALS["POPOUT"] != "off" ) ) ? "<img src='$base_url/pics/space_big.png' width='25' height='24' border='0' alt='' style='width: 25px; height: 24px; cursor: pointer;' id='phplive_embed_menu_popout' onClick='phplive_widget_embed_popout( )'>" : "<img src='$base_url/pics/space_big.png' width='25' height='24' border='0' alt='' style='width: 25px; height: 24px;' id='phplive_embed_menu_popout'>" ;
...
if ( typeof( phplive_widget_embed ) == "undefined" )
{
	...
	var phplive_widget = "<map name='initiate_chat_cover'><area shape='rect' coords='222,2,247,26' href='JavaScript:void(0)' onClick='phplive_widget_decline( )'><area shape='rect' coords='0,26,250,160' href='JavaScript:void(0)' onClick='phplive_widget_launch( )'></map><div id='phplive_widget' name='phplive_widget' style='display: none; position: "+this_position+"; <?php echo $widget_top_left ?> background: url( <?php echo $widget_shadow_image ?> ) repeat; padding: 10px; width: "+phplive_widget_width+"px; height: "+phplive_widget_height+"px; -moz-border-radius: 5px; border-radius: 5px; z-Index: 40000;'></iframe></div><div id='phplive_widget_image' style='display: none; position: "+this_position+"; <?php echo $widget_cover_top_left ?> padding: 10px; z-Index: 40001;'><img src='"+phplive_widget_image+"' id='phplive_widget_image_img' width='250' height='160' border=0 usemap='#initiate_chat_cover' style='width: 250px; height: 160px; -moz-border-radius: 5px; border-radius: 5px;'></div>" ;
	var phplive_widget_embed_div = "<div id='phplive_widget_embed_iframe_loading' style='display: none; position: fixed; width: 31px; height: 31px; padding: 2px; right: 25px; bottom: 5px; background: #FFFFFF; border: 1px solid #F1F5FB; -moz-border-radius: 5px; border-radius: 5px; z-Index: 40005;'><img src='<?php echo $base_url ?>/themes/initiate/loading.gif' width='31' height='31' border='0' alt='' style='width: 31px; height: 31px; -moz-border-radius: 5px; border-radius: 5px;'></div> \
	<div id='phplive_widget_embed_iframe' style='position: fixed; width: <?php echo $VARS_CHAT_WIDTH_WIDGET ?>px; height: <?php echo $VARS_CHAT_HEIGHT_WIDGET ?>px; right: 25px; text-align: left; bottom: 50000px; z-Index: 40003;'> \
		<div id='phplive_widget_embed_iframe_wrapper' style='width: 100%; height: 100%; -moz-border-radius: 5px; border-radius: 5px;'></div>\
		<div id='phplive_widget_embed_actions' style='position: absolute; top: 0px; left: 0px; width: <?php echo $VARS_CHAT_WIDTH_WIDGET ?>px; height: 24px;'><img src='<?php echo $base_url ?>/pics/space_big.png' width='25' height='24' border='0' alt='' style='display: none; width: 25px; height: 24px; cursor: pointer;' id='phplive_embed_menu_maximize' onClick='phplive_widget_embed_maximize( )'><img src='<?php echo $base_url ?>/pics/space_big.png' width='25' height='24' border='0' alt='' style='width: 25px; height: 24px; cursor: pointer;' id='phplive_embed_menu_minimize' onClick='phplive_widget_embed_minimize( )'> <?php echo $popout_div ?><img src='<?php echo $base_url ?>/pics/space_big.png' width='<?php echo ($VARS_CHAT_WIDTH_WIDGET-90) ?>' height='24' border='0' alt='' style='width: <?php echo ($VARS_CHAT_WIDTH_WIDGET-90) ?>px; height: 24px;'><img src='<?php echo $base_url ?>/pics/space_big.png' width='25' height='24' border='0' alt='' style='width: 25px; height: 24px; cursor: pointer;' onClick='phplive_widget_embed_close( )'></div> \
	</div> \
	<div id='phplive_widget_embed_iframe_shadow' style='display: none; position: fixed; width: 423px; height: 538px; right: 19px; bottom: 0px; z-Index: 40000;'><img src='<?php echo $base_url ?>/themes/initiate/widget_shadow.png' width='423' height='538' border='0' alt='' style='width: 423px; height: 538px;'></div><div id='phplive_widget_embed_iframe_shadow_minimzed' style='display: none; position: fixed; width: 265px; height: 55px; right: 20px; bottom: 0px; z-Index: 40000;'><img src='<?php echo $base_url ?>/themes/initiate/widget_shadow_minimized.png' width='265' height='55' border='0' alt='' style='width: 265px; height: 55px;'></div>" ;
	...
	{
		phplive_jquery('#phplive_widget_embed_iframe').css({'height': <?php echo $VARS_CHAT_HEIGHT_WIDGET ?>}) ;
		phplive_jquery('#phplive_widget_embed_iframe').css({'width': <?php echo $VARS_CHAT_WIDTH_WIDGET ?>}) ;
...
if ( typeof( phplive_thec_<?php echo $deptid ?> ) == "undefined" )
{
	...
	window.phplive_launch_chat_<?php echo $deptid ?> = function( theflag, theminmax, thetheme, theforce, theauto, thewidget )
	{
		...
		else
		{
			...
			if ( <?php echo $VARS_CHAT_WIDTH_WIDGET ?> > phplive_win_width ) { launch_embed = 0 ; }
...
if ( typeof( phplive_btn_loaded_<?php echo $btn ?> ) == "undefined" )
{
	...
	var phplive_interval_jquery_check_<?php echo $btn ?> = setInterval(function( ){
        if ( typeof( phplive_jquery ) != "undefined" ){
			clearInterval( phplive_interval_jquery_check_<?php echo $btn ?> ) ; phplive_interval_jquery_check_<?php echo $btn ?> = this.undefined ;
