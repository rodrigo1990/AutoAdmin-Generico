...
function do_alert_div( thepath, theflag, thetext )
{
	...
	if ( theflag )
		...
		$('#div_alert').removeClass("info_good").removeClass("info_error").addClass("info_error").html( "<img src=\""+thepath+"/pics/icons/warning.png\" width=\"12\" height=\"12\" border=\"0\" alt=\"\"> "+thetext ) ;
...
function activate_theme( title ) {
	document.getElementById('stylesheet').href = base_url+'/themes/'+title+'/style.css' ;
}
