<?php
	...
	$success = Util_Format_Sanatize( Util_Format_GetVar( "success" ), "ln" ) ;
...
<!--
	var st_geo_import ;
	var st_geo_import_cycle = 2 ; // seconds
	var global_ip ;
	...
	{
		if ( confirm( "This process may take up to 15 minutes. Continue?" ) )
		{
			$(window).scrollTop(0) ;
			check_geo_files(0, 0) ;
		}
	...
	function check_geo_files( theindex, thepercent )
	{
		...
		success: function(data){
			...
			if ( !json_data.status && ( typeof( json_data.error ) == "undefined" ) )
			{
				...
				if ( typeof( st_geo_import ) != "undefined" ) { clearTimeout( st_geo_import ) ; st_geo_import = this.undefined ; }
						...
						<td width="33%" valign="top" style="padding-right: 5px;">
							<div style="height: 210px;" class="info_info">
								...
								<div style="margin-top: 5px;">
									...
									<div style="margin-top: 15px;">(~23 Megs GZ compressed)</div>
						...
						<td width="33%" valign="top" style="">
							<div style="height: 210px;" class="info_info">
								...
								<div style="margin-top: 5px;">
									...
									<div style="margin-top: 15px;">FTP process of the <code>"geo_data/"</code> folder to your server may take 10-30 minutes.  Once the folder is uploaded, click the button to import the data.</div>
								</div>
				...
				<?php else: ?>
					<div style="margin-top: 25px;">
						...
						<div id="div_maps_steps" style="display: none;">
							...
							<div style="margin-top: 5px;">Login to the <a href="https://console.developers.google.com/project" target="_blank">Google Code Console</a> and select a project (or create a new project if none exists).  After selecting a project, click the <span style="font-weight: bold; color: #3D7DE7;">BIG blue box</span> "Use Google APIs".  On the list of APIs page, there should be "Google Maps APIs" section with a list of available APIs.  Enable the "<b>Google Maps JavaScript API</b>".</div>
							...
							<div style="margin-top: 15px; padding: 5px;">
								...
								<div style="margin-top: 15px;"><input type="text" id="apikey" name="apikey" class="input" size="50" maxlength="55" value="<?php echo ( $geomap ) ? $CONF["geo"] : "" ; ?>"></div>
								<div style="margin-top: 15px;">
