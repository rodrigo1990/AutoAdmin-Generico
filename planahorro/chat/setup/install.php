<?php
	...
	if ( $safe_mode || ( $ini_safe_mode == 1 ) )
	{
		...
		{ include_once( "../README/PREP.html" ) ; exit ; }
	}
	...
	if ( $action == "create_dirs" )
	{
		...
		if ( !is_writable( "../web/chat_sessions" ) || !is_dir( "../web/chat_initiate" ) || !is_dir( "../web/patches" ) )
	...
	<div style="margin-bottom: 25px;">
		...
		<tr>
			...
			<td style="padding-left: 25px;">
				<div style="font-size: 20px; text-decoration: 1px 1px #FFFFFF;">Installation</div>
	...
	<div style="">
		...
		<tr>
			<td valign="top" width="50%">
				<table cellspacing=0 cellpadding=0 border=0 width="100%">
				<tr>
					<td colspan=2><div class="op_submenu_focus"><span class="edit_title">Create Setup Admin Profile</span></div></td>
				</tr>
				<?php if ( $pv >= "5.1.0" ): ?>
				<tr>
			...
			<td valign="top" width="50%">
				<table cellspacing=0 cellpadding=0 border=0 width="100%">
				<tr>
					<td colspan=2><div class="op_submenu_focus"><span class="edit_title">Database Settings</span></div></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan=2 class="td_dept_td_blank">
						<div><img src="../pics/icons/info.png" width="12" height="12" border="0" alt=""> Create a database for your PHP Live! system and provide the information below.</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_dept_td_blank"><input type="password" class="input" size="35" maxlength="55" name="db_password" id="db_password" onKeyPress="return noquotestags(event)" value=""><div style="font-size: 10px;">* no quotes ('") or tag characters (&lt;&gt;)</div></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
