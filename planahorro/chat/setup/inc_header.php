	...
	<div style="background: url( <?php echo $CONF["BASE_URL"] ?>/pics/clouds.png ) repeat-x; background-position: bottom;">
		<div style="width: 970px; margin: 0 auto;">
			<div id="menu_wrapper" style="padding-top: 20px;">
				...
				<div id="menu_interface" class="menu" onClick="location.href='<?php echo $CONF["BASE_URL"] ?>/setup/interface.php?ses=<?php echo $ses ?>'"><img src="<?php echo $CONF["BASE_URL"] ?>/pics/icons/menu_icons.png" width="12" height="12" border="0" alt=""> Interface</div>
				...
				<div id="menu_rtraffic" class="menu" onClick="location.href='<?php echo $CONF["BASE_URL"] ?>/setup/reports_traffic.php?ses=<?php echo $ses ?>'"><img src="<?php echo $CONF["BASE_URL"] ?>/pics/icons/menu_marketing.png" width="12" height="12" border="0" alt=""> Traffic</div>
			...
			<div style="width: 970px; margin: 0 auto; padding-bottom: 10px;">
				...
				<tr>
					...
					<td align="right" style="padding-left: 15px;" nowrap>
						<div style="padding: 10px; background: #FFFFFF; border: 5px solid #EDF6FA; color: #A3A3A3; text-align: center;" class="round_top">Logged in as: <a href="<?php echo $CONF["BASE_URL"] ?>/setup/settings.php?ses=<?php echo $ses ?>&jump=profile"><b><?php echo $admininfo["login"] ?></b></a> &bull; <a href="<?php echo $CONF["BASE_URL"] ?>/logout.php?action=logout&menu=sa" style="">logout</a></div>
					</td>
				</tr>
				</table>
			</div>
