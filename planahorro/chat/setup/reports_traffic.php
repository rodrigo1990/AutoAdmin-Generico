			...
			<div class="info_neutral" style="text-shadow: none; margin-top: 25px;">
				...
				<tr>
					...
					<td style="padding-left: 10px; text-align: justify;">
						...
						<div style="margin-top: 10px;">To further conserve server resources, the <a href="settings.php?ses=<?php echo $ses ?>&jump=misc_settings#footprints">footprint tracking can be switched off altogether</a>.</div>
					</td>
				</tr>
				</table>
			</div>
