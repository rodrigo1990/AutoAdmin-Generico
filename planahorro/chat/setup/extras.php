				...
				<div style="margin-top: 25px;">
					...
					<div style="margin-top: 5px;">
						...
						<tr>
							...
							<td class="td_dept_td"><input type="text" class="input" style="background: #CEE0F4;" id="api_traffic" readonly size="90" value="<?php echo ( !preg_match( "/^(http)/", $CONF["BASE_URL"] ) ) ? "http$https:$CONF[BASE_URL]" : $CONF["BASE_URL"] ; ?>/http/traffic.php?akey=<?php echo $CONF["API_KEY"] ?>" onMouseDown="setTimeout(function(){ $('#api_traffic').select(); }, 200);"></td>
						</tr>
						</table>
					</div>
