	...
	<div style="padding: 25px; background: #FAFAFA;">
		<div id="div_message_body" class="round">
			...
			<tr>
				...
				<td><div class="td_dept_td_blank" style="padding: 4px; text-shadow: none;"><span id="msg_from_name"><?php echo $message["vname"] ?></span> &lt;<span id="msg_from_email"><?php echo $message["vemail"] ?></span>&gt;</div></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td valign="top">
					<div class="td_dept_td_blank" style="padding: 4px; text-shadow: none;">
						<div id="msg_created" style=""><?php echo $created ?></div>
						<div id="msg_message" style="padding: 5px; margin-top: 15px; height: 150px; overflow: auto; border: 1px dashed #A9A9AA;" class="round"><?php echo $message_body ?></div>
					</div>
				</td>
			</tr>
			<tr>
