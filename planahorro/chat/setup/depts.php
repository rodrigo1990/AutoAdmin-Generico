<?php
	...
	$ao = Util_Format_Sanatize( Util_Format_GetVar( "ao" ), "ln" ) ;
...
<?php include_once( "./inc_header.php" ) ?>
						...
						<div style="margin-top: 25px; text-shadow: none;" class="info_info">
							...
							<div style="margin-top: 5px;">
								...
								<div id="primary_theme_confirm" style="display: none;" class="info_box">
									Update theme? <button type="button" onClick="update_theme($('#theme_pr').val())" class="btn">Yes, Update</button> &nbsp; <a href="JavaScript:void(0)" onClick="$('#primary_theme_confirm').hide() ;$('#primary_theme_select').show() ;" style="font-size: 10px;">cancel</a>
								</div>
							</div>
						</div>
					<?php endif; ?>
		...
		<div id="div_list" style="margin-top: 25px;">
			...
			<?php
				...
				for ( $c = 0; $c < count( $departments ); ++$c )
				{
					...
					$auto_offline_img = ( isset( $auto_offline[$department["deptID"]] ) ) ? "online_green.png" : "bullet_red.png" ;
					...
					$options = "
						...
						<span class=\"op_submenu2\" id=\"menu_8_$department[deptID]\" style=\"\" onClick=\"do_options( 8, $department[deptID] );\"><img src=\"../pics/icons/$auto_offline_img\" width=\"12\" height=\"12\" border=\"0\" alt=\"\" id=\"auto_offline_img_$department[deptID]\"> Automatic Offline</span>
					...
					<tr id=\"div_tr_$department[deptID]\">
						...
						<td class=\"$td1\">
							<div><b>$name</b></div>
							<div class=\"info_neutral\" style=\"margin-top: 5px; font-size: 10px; width: 45px;\">ID: $department[deptID]</div>
						</td>
		...
		<div id="div_form" style="display: none;" id="a_edit">
			...
			<div style="margin-top: 15px;">
				...
				<tr>
					...
					<td style="padding-left: 10px;">
						...
						<div style="margin-top: 3px;"><input type="radio" name="rtype" id="rtype_2" value="2" checked> <span style="font-weight: bold; color: #5D5D5D;">Round-Robin:</span> Operator who has not accepted a chat the longest will receive the request first.</div>
			...
			<div style="margin-top: 15px;">
				...
				<tr>
					...
					<td style="padding-left: 10px;">
						When a visitor requests live chat, choose whether to display this department on the selection list. <input type="radio" name="visible" id="visible_1" value="1" checked> Yes <input type="radio" name="visible" id="visible_0" value="0" onClick="check_departments_total()"> No
		...
		<div id="div_notice_delete" style="display: none; position: absolute; text-align: justify;" class="info_error">
			<div style="padding: 10px;">
				...
				<div style="margin-top: 5px;">To retain the department chat transcripts and chat stats, it is recommended to edit the department and set the "Visible for Selection" to "No" rather then permanently deleting the department and it's data.</div>
