		...
		<div style="margin-top: 25px;">
			...
			<tr>
				<td colspan=2 style="padding-top: 15px;">
					<div style=""><img src="../pics/icons/bullet_red.png" width="16" height="16" border="0" alt=""> chat request was dropped during the routing process due to internet lag, browser closed, etc.  The request did not complete the routing cycle.</div>
					...
					<div style="margin-top: 5px;"><img src="../pics/icons/bullet_blue.png" width="16" height="16" border="0" alt=""> chat request completed the routing cycle to all operators within the department but the request was not accepted.  The request went to the leave a message page.</div>
