...
<!--
	...
	$(document).ready(function()
	{
		...
		$('#chat_body').html( "<div class='ca'>Session ID: <?php echo $ces ?></div><div class='ca'>Visitor ID: <?php echo $requestinfo["md5_vis"] ?></div>"+init_timestamps( transcript.emos() ) ) ;
...
<div style="position: absolute; top: 2px; padding: 10px; z-Index: 2; overflow: auto;">
	...
	<div id="chat_input" style="margin-top: 8px; padding: 5px; -moz-border-radius: 5px; border-radius: 5px;">
		...
		<tr>
			...
			<td valign="top">
				...
				<tr>
					...
					<td><div class="chat_info_td_traffic"><?php echo ( $requestinfo["initiated"] ) ? "<img src=\"../themes/$CONF[THEME]/info_initiate.gif\" width=\"10\" height=\"10\" border=\"0\" alt=\"\" title=\"Operator Initiated Chat\" alt=\"Operator Initiated Chat\" style=\"cursor: help;\"> " : "" ; ?><b><?php echo $opinfo_["name"] ; ?></b> <span style="font-size: 10px;"><?php echo "<a href='mailto:$opinfo_[email]' target='new'>$opinfo_[email]</a>" ?></span></div></td>
				</tr>
				<tr>
		...
		<div id="table_email" style="display: none; position: relative; top: -70px; padding: 10px;" class="info_content">
			<form>
			...
			<tr>
				<td colspan=2>Message:<br><textarea class="input_text" rows="7" style="width: 94%; resize: none;" wrap="virtual" id="message">Hi <?php echo $requestinfo["vname"] ?>,
