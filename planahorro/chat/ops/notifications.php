...
<!--
	...
	function demo_sound2()
	{
		...
		play_sound(0, 'new_request', 'new_text_'+sound) ;
	}
	...
	function update_sound()
	{
		...
		location.href = 'notifications.php?console=<?php echo $console ?>&ses=<?php echo $ses ?>&wp=<?php echo $wp ?>&auto=<?php echo $auto ?>&console=<?php echo $console ?>&action=update_sound&sound1='+sound1+'&sound2='+sound2 ;
	}
...
<?php include_once( "./inc_header.php" ); ?>
		...
		<div class="op_submenu_wrapper">
			...
			<div class="op_submenu" onClick="show_div('sms')" id="menu_sms">SMS</div>
			<div style="clear: both"></div>
		</div>

		<div id="op_sounds" style="display: none; margin-top: 15px;">
			<img src="../pics/icons/bell_start.png" width="16" height="16" border="0"> Customize the operator console sound alerts.  If the operator console is open, refresh the console window for the new sound to take affect.

			<table cellspacing=0 cellpadding=0 border=0 width="100%" style="margin-top: 25px;">
			<tr>
				<td valign="top" style="width: 230px;">
					<div class="info_info">
						<div style=""><img src="../pics/icons/bell_start.png" width="16" height="16" border="0" alt=""> Chat request sound alert</div>
						<div style="margin-top: 10px;">
							<div class="info_good" style="float: left; width: 60px; padding: 3px;"><input type="radio" name="console_sound" id="console_sound_on" value=1 <?php echo $sound_on ?> onClick="toggle_console_sound(1)"> On</div>
							<div class="info_error" style="float: left; margin-left: 10px; width: 60px; padding: 3px;"><input type="radio" name="console_sound" id="console_sound_off" value=0 <?php echo $sound_off ?> onClick="toggle_console_sound(0)"> Off</div>
							<div style="clear: both;"></div>
						</div>
					</div>
					<div style="margin-top: 15px;" class="info_info">
						...
						<div><img src="../pics/icons/blink.png" width="16" height="16" border="0" alt=""> Chat request console blink</div>
						<div style="margin-top: 10px;">
							<div class="info_good" style="float: left; width: 60px; padding: 3px;"><input type="radio" name="console_blink" id="console_blink_on" value=1  <?php echo $blink_on ?> onClick="toggle_console_blink(1, 1)"> On</div>
							<div class="info_error" style="float: left; margin-left: 10px; width: 60px; padding: 3px;"><input type="radio" name="console_blink" id="console_blink_off" value=0 <?php echo $blink_off ?> onClick="toggle_console_blink(0, 1)"> Off</div>
							<div style="clear: both;"></div>
						</div>
					</div>
					<div style="margin-top: 15px;" class="info_info">
						<div><img src="../pics/icons/blink.png" width="16" height="16" border="0" alt=""> Chat response console blink</div>
						<div style="margin-top: 10px;">
							<div class="info_good" style="float: left; width: 60px; padding: 3px;"><input type="radio" name="console_blink_r" id="console_blink_r_on" value=1  <?php echo $blink_r_on ?> onClick="toggle_console_blink_r(1, 1)"> On</div>
							<div class="info_error" style="float: left; margin-left: 10px; width: 60px; padding: 3px;"><input type="radio" name="console_blink_r" id="console_blink_r_off" value=0 <?php echo $blink_r_off ?> onClick="toggle_console_blink_r(0, 1)"> Off</div>
							<div style="clear: both;"></div>
						</div>
					</div>
				</td>
					...
					<div id="dn_enabled" style="display: none;">
						...
						<tr>
								...
								<div style="" class="info_info">
									...
									<div class="info_neutral" style="margin-top: 15px;">
										...
										<tr>
											...
											<td>Only display the Desktop Notification if the operator console is out of focus</td>
										</tr>
										</table>
									</div>
								</div>
							...
							<td valign="top" style="padding-left: 50px;">
								...
								<div style="margin-top: 5px;"><a href="JavaScript:void(0)" onClick="dn_show( 'new_chat', '<?php echo time() ?>', 'Demo Visitor', 'This is a demo chat request question.', 15000 )">Click for demo notification.</a></div>
