...
<body id="chat_info_body" style="margin: 0px; border: 0px; padding: 0px;">
	...
	<div id="map_default" style="display: none; height: 100%;">
		...
		<?php else: ?>
			...
			<?php else: ?>
			<div class="chat_info_td">To enable GeoIP Location, contact the setup admin.  The setup admin will need to login to the setup area and access the top menu "Extras".  On the "Extras" page, click the "GeoIP" sub menu.</td>
			<?php endif ; ?>
