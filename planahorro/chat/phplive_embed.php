...
<div id="div_menu" style="">
	<div id="chat_embed_header" style="width: <?php echo $VARS_CHAT_WIDTH_WIDGET ?>;">
		...
		<tr>
			<td style="width: 16px;"><img src="./themes/<?php echo $theme ?>/win_max.png" width='16' height='16' border='0' alt='' style='display: none; width: 16px; height: 16px; cursor: pointer;' id="menu_maximize"><img src="./themes/<?php echo $theme ?>/win_min.png" width='16' height='16' border='0' alt='' style='width: 16px; height: 16px; cursor: pointer;' id="menu_minimize"></td>
			<?php if ( !isset( $VALS["POPOUT"] ) || ( $VALS["POPOUT"] != "off" ) ): ?><td style="width: 16px;"><img src="./themes/<?php echo $theme ?>/win_pop.png" width='16' height='16' border='0' alt='' style='width: 16px; height: 16px; cursor: pointer;' id="menu_popout"></td><?php endif ; ?>
			<td style="width: <?php echo ($VARS_CHAT_WIDTH_WIDGET-90) ?>px;">
				<span id="chat_embed_title" style="white-space: nowrap;"><img src="./themes/<?php echo $theme ?>/lock.png" width="12" height="12" border="0" alt="" id="img_lock" style="display: none;"> <?php echo $LANG["TXT_LIVECHAT"] ?></div>
			</td>
			<td style="padding-right: 10px; width: 16px;"><img src='./themes/<?php echo $theme ?>/win_close.png' width='16' height='16' border='0' alt='' style='width: 16px; height: 16px; cursor: pointer;' id="menu_close"></td>
		</tr>
		</table>
	</div>
</div>
<div id="iframe_div" style="-moz-border-radius: 5px; border-radius: 5px;"></div>
