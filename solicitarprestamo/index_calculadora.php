  ...
  <div id="contanedor">
    ...
    <div class="col-sm-6" id="derecha_form">
      ...
      <div class="row slider-container">
        <div class="col-sm-12">
            <div id="valor1_slider">$3.000</div>
            <div id="valor2_slider">$100.000</div>
          <input class="slider" name="valor_monto" type="text" data-slider-min="2000" data-slider-max="101000" data-slider-step="1000" data-slider-tooltip="show" data-slider-value="20000"/>
        </div>
        <div class="col-sm-12">
          <input class="slider-txt" type="text" pattern="\d*" data-inputmask="" value="" disabled />
        </div>
      </div>

      <div id="ingreso_neto">Tu ingreso neto en mano debe ser de <a id="valor_ingreso">$10.000</a></div>
      ...
      <div id="form">
          <div class="row">
            <div class="col-sm-6">
              ...
              <input type="text" name="nombre" class="input_form" placeholder="Ej: Juan" required />
            </div>
            <div class="col-sm-6">
              <label>Apellido</label><br />
              <input type="text" name="apellido" class="input_form" placeholder="Ej. Gomez" required />
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <label>Sexo</label><br />
              <input type="radio" name="sexo" value="Masculino" checked /> Masculino <input type="radio" name="sexo" value="Femenino" style="margin-left: 20px;" /> Femenino
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <input type="date" name="fecha_nacimiento" class="input_form" placeholder="Ej: dd/mm/aaaa" required />
            </div>
            <div class="col-sm-6">
              <label>Email</label><br />
              <input type="email" name="mail" class="input_form" placeholder="Ej. juangomez@gmail.com" required  />
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <select name="banco" class="input_form">
                ...
                <option>Banco Provincia de Chubut</option>
        ...
        <div class="row">
          <div class="col-sm-5">
            <label style="font-size: 17px;">Acepto los <a class="fancybox" href="#terminos_condiciones">t&eacute;rminos y condiciones</a></label><br />
            <input type="checkbox" name="acepto_condiciones" required style="margin-left: 7px; width: 16px; height: 16px;" />
          </div>
