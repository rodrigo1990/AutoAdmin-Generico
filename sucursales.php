  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
        <div class="item_sucursal">
          <img src="imagenes/sucursales/casa_central.jpg" alt="CASA CENTRAL" class="img_full" />
          <span>CASA CENTRAL</span><br />
          Av. del Libertador 174, Vicente Lopez
          <br /><br />
          <b>TEL:</b> 7078-6500
        </div>
      </div>
...
<script>
  function initMap() {
    var uluru = {lat: -34.532940, lng: -58.468865};
