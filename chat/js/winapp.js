...
{
	// there is a bug in function wp_new_win().  for now open as IE browser
	//window.external.wp_new_win( theurl, thetitle, thew, theh ) ;

	var newwin = window.open( theurl, thetitle, "scrollbars=yes,menubar=no,resizable=1,location=no,width="+thew+",height="+theh+",status=0" ) ;
}
