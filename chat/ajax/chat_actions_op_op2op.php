<?php
	...
	else if ( $action == "op2op" )
	{
		...
		if ( isset( $opinfo["opID"] ) )
		{
			...
			if ( $requestid = Chat_put_Request( $dbh, $deptid, $opid, 0, 0, $opid_cookie, 0, $os, $browser, $ces, $resolution, $opinfo["name"], $opinfo["email"], $ip, "", "op2op", "", "", "Operator 2 Operator Chat", 0, "", "" ) )
			{
