			...
			<td valign="top">
				<div class="home_box" id="home_full_list" style="margin-left: 0px; width: 280px;">
					...
					<div id="home_full_list_content" class="td_dept_td" style="height: 400px; overflow: auto; padding-top: 0px;">
						...
						<div class="home_box_li_blank" style="">
							<div><span style="padding: 5px; background: url( ../pics/bg_tab.gif ) repeat-x #3FBBCA; color: #FFFFFF; border: 1px solid #6EA6BF;" class="round"><img src="../pics/icons/menu_chats.png" width="12" height="12" border="0" alt=""></span> &nbsp; <a href="reports_chat.php?ses=<?php echo $ses ?>">Report: Chats</a></div>
							<div style="padding-left: 19px; margin-top: 5px; font-decoration: normal;">
						...
						<div class="home_box_li_blank" style="">
							<div><span style="padding: 5px; background: url( ../pics/bg_tab.gif ) repeat-x #3FBBCA; color: #FFFFFF; border: 1px solid #6EA6BF;" class="round"><img src="../pics/icons/menu_traffic.png" width="12" height="12" border="0" alt=""></span> &nbsp; <a href="reports_traffic.php?ses=<?php echo $ses ?>">Report: Traffic</a></div>
							<div style="padding-left: 19px; margin-top: 5px; font-decoration: normal;">
								...
								<div class="home_box_menu_li"> <a href="reports_traffic.php?ses=<?php echo $ses ?>&jump=foot_settings">Footprint Logging Setting</a></div>
								<div class="home_box_menu_li"> <a href="reports_traffic.php?ses=<?php echo $ses ?>&jump=foot_icon">Status Check Requests</a></div>
							</div>
						</div>
						<div class="home_box_li_blank" style="">
							<div><span style="padding: 5px; background: url( ../pics/bg_tab.gif ) repeat-x #3FBBCA; color: #FFFFFF; border: 1px solid #6EA6BF;" class="round"><img src="../pics/icons/menu_marketing.png" width="12" height="12" border="0" alt=""></span> &nbsp; <a href="marketing.php?ses=<?php echo $ses ?>">Marketing</a></div>
							<div style="padding-left: 19px; margin-top: 5px; font-decoration: normal;">
								...
								<!-- <div class="home_box_menu_li"> <a href="marketing_gcode.php?ses=<?php echo $ses ?>">Google Analytics</a></div> -->
							</div>
						</div>
						<div class="home_box_li_blank" style="">
						...
						<div class="home_box_li_blank" style="">
							...
							<div style="padding-left: 19px; margin-top: 5px; font-decoration: normal;">
								<div class="home_box_menu_li"> <a href="settings.php?ses=<?php echo $ses ?>">Logo</a></div>
								<div class="home_box_menu_li"> <a href="settings.php?ses=<?php echo $ses ?>&jump=themes">Themes</a></div>
								<div class="home_box_menu_li"> <a href="settings.php?ses=<?php echo $ses ?>&jump=embed">Chat</a></div>
								...
								<div class="home_box_menu_li"> <a href="settings.php?ses=<?php echo $ses ?>&jump=sips">Block IPs</a></div>
						...
						<td valign="top">
							<div id="home_box_start" class="home_box" style="width: 280px; padding-right: 0px; background: url( ../pics/intro.gif ) no-repeat; background-position: bottom right;">
								...
								<div style="text-shadow: 1px 1px #FFFFFF; padding-top: 10px;">
									<div class="home_box_li_blank" style="margin-top: 0px;"><span style="padding: 5px; background: url( ../pics/bg_tab.gif ) repeat-x #3FBBCA; color: #FFFFFF; border: 1px solid #6EA6BF;" class="round"><img src="../pics/icons/menu_depts.png" width="12" height="12" border="0" alt=""></span> &nbsp; <a href="depts.php?ses=<?php echo $ses ?>">Manage Departments</a></div>
									<div class="home_box_li_blank" style="margin-top: 10px;"><span style="padding: 5px; background: url( ../pics/bg_tab.gif ) repeat-x #3FBBCA; color: #FFFFFF; border: 1px solid #6EA6BF;" class="round"><img src="../pics/icons/menu_ops.png" width="12" height="12" border="0" alt=""></span> &nbsp; <a href="ops.php?ses=<?php echo $ses ?>">Manage Operators</a></div>
