	...
	<div style="">
		...
		<div style="">
			...
			<div style="padding-bottom: 15px; text-align: justify;">
				...
				<div style="float: left; margin-left: 2px; min-height: 120px; width: 370px;" class="info_info">
			...
			<div style="padding-bottom: 15px; text-align: justify;">
				...
				<div style="float: left; margin-left: 2px; min-height: 180px; width: 370px;" class="info_info">
					...
					<div style="margin-top: 10px; font-size: 10px;" class="info_box">Current fields are Name, Email and Question.  Additional field to display to the visitor could be "Login", "Phone", "Order Number", etc.</div>
					<div style="margin-top: 10px;">
