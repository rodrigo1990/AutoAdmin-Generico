			...
			<tr>
				<?php
					for ( $c = 1; $c <= $stat_end_day; ++$c )
					{
						...
						$stat_day_expand = date( "l, M j, Y", $stat_day ) ;
						print "
							<td align=\"center\"><div id=\"requests_bg_day\" class=\"page_report\" style=\"margin: 0px; font-size: 10px; font-weight: bold;\" title=\"$tooltips[$stat_day]\" id=\"$tooltips[$stat_day]\" OnMouseOver=\"\" OnClick=\"select_date( $stat_day, '$stat_day_expand' );\">$c</div></td>
							<td><img src=\"../pics/space.gif\" width=\"5\" height=1></td>
						" ;
					}
				?>
			...
			<div id="overview_data_container" style="margin-top: 15px;">
				...
				<div id="reports_info" style="display: none;">
					...
					<ul style="margin-top: 15px;">
						...
						<li> One chat request to a department could count towards several department <b>"Declined"</b> depending on the numbers of operators assigned to the department.
