...
<!--
	...
	function do_delete( theopid )
	{
		...
		var height = $('#div_tr_'+theopid).outerHeight() ;
	...
	function do_submit()
	{
		...
		var password = phplive_md5( $( "input#password" ).val() ) ; $( "input#password" ).val( password ) ;
...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div id="ops_main">
			...
			<div id="div_list" style="margin-top: 25px;">
				...
				<tr>
					...
					<td width="50" nowrap align="center"><div class="td_dept_header" style="cursor: help;" title="maximum concurrent chat sessions" alt="maximum concurrent chat sessions">Max</div></td>
				...
				<?php
					...
					for ( $c = 0; $c < count( $operators ); ++$c )
					{
						...
						$edit_delete = "<div style=\"cursor: pointer;\" onClick=\"do_edit( $operator[opID], '$operator[name]', '$operator[email]', '$operator[login]', $operator[rate], $sms_edit, $operator[op2op], $operator[traffic], $operator[viewip], $operator[maxc] )\"><img src=\"../pics/btn_edit.png\" width=\"64\" height=\"23\" border=\"0\" alt=\"\"></div><div onClick=\"do_delete($operator[opID])\" style=\"margin-top: 10px; cursor: pointer;\"><img src=\"../pics/btn_delete.png\" width=\"64\" height=\"23\" border=\"0\" alt=\"\"></div>" ;
		...
		<div id="div_form" style="display: none; margin-top: 25px;" id="a_edit">
			...
			<div style="margin-top: 15px;">
				<table cellspacing=0 cellpadding=0 border=0>
				<tr>
					<td><div class="tab_form_title">Concurrent Chat Sessions<div style="font-size: 10px; font-weight: normal;">Does not apply to simultaneous routing type.</div></div></td>
					<td style="padding-left: 10px;">For new chat requests, automatically skip this operator when the operator has reached
						...
						</select> concurrent chat sessions.
					</td>
				</tr>
				</table>
			</div>
		...
		<div id="div_notice_delete" style="display: none; position: absolute; text-align: justify;" class="info_error">
			<div style="padding: 10px;">
				<div class="edit_title">Really delete this operator?</div>
