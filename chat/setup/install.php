		...
		if ( !$error )
		{
			...
			if ( !$error )
			{
				...
				else
				{
					...
					{
						$now = time() ;
						LIST( $login, $password ) = database_mysql_quote( $login, $password ) ;
...
<!--
	...
	function install()
	{
		...
		var vpassword = phplive_md5( password+$.cookie("phplive_token") ) ;
...
<div id="body" style="width: 970px; margin: 0 auto; margin-top: 15px;" class="info_info">
	<div style="margin-bottom: 25px;">
		...
		<tr>
			...
			<td style="padding-left: 25px; font-size: 20px; text-decoration: 1px 1px #FFFFFF;">Installation</td>
		</tr>
		</table>
	</div>
		...
		<tr>
			<td valign="top" width="50%">
				...
				<tr>
					...
					<td class="td_dept_td_blank"><div style="font-size: 10px;">* letters and numbers only</div><input type="text" class="input" size="35" maxlength="15" name="login" id="login" onKeyPress="return nospecials(event)" value=""></td>
				</tr>
				<tr>
					<td class="td_dept_td_blank" nowrap>Setup Password</td>
					<td class="td_dept_td_blank"><input type="password" class="input" size="35" maxlength="50" name="password" id="password" value=""><div style="font-size: 10px;"></div></td>
				</tr>
				<tr>
					<td class="td_dept_td_blank" nowrap>Verify Password</td>
					<td class="td_dept_td_blank"><input type="password" class="input" size="35" maxlength="50" name="vpassword" id="vpassword" value=""><div style="font-size: 10px;"></div></td>
				</tr>
				<tr>
			...
			<td valign="top" width="50%">
				...
				<tr>
					...
					<td class="td_dept_td_blank"><div style="font-size: 10px;">* no quotes ('") or tag characters (&lt;&gt;)</div><input type="password" class="input" size="35" maxlength="55" name="db_password" id="db_password" onKeyPress="return noquotestags(event)" value=""></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
