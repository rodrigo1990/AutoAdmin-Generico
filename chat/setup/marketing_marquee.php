...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div class="op_submenu_wrapper">
			...
			<!-- <div class="op_submenu" onClick="location.href='marketing_gcode.php?ses=<?php echo $ses ?>'">Google Analytics</div> -->
				...
				<tr>
					<td>Marquee Message - displayed (example: "Receive FREE shipping today!")
						...
						<div style="padding: 5px;"><img src="../pics/icons/info.png" width="12" height="12" border="0" alt="">
							To link a <b>URL</b> and <i><b>email</b></i> addresses, use the [url] and [email] codes, detailed below.
						...
						<div style="margin-top: 10px; font-size: 10px"><img src="../pics/icons/warning.png" width="12" height="12" border="0" alt=""> short and sweet messages to limit the text going beyond the default chat window width</div>
						<div style="margin-top: 5px;"><input type="text" name="message" id="message" size="120" maxlength="255" value="" onKeyPress="return notags(event)"></div>
						<div style="margin-top: 10px;">&middot; <a href="JavaScript:void(0)" onClick="view_marquee()">view how it looks</a></div>
					</td>
				</tr>
				<tr>
		...
		<div id='phplive_widget_embed_iframe' style='position: fixed; width: <?php echo $VARS_CHAT_WIDTH_WIDGET ?>px; height: <?php echo $VARS_CHAT_HEIGHT_WIDGET ?>px; right: 5px; bottom: 5000px; -moz-border-radius: 5px; border-radius: 5px; z-Index: 40003;'><iframe id='iframe_widget_embed' name='iframe_widget_embed' style='width: 100%; height: 100%; -moz-border-radius: 5px; border-radius: 5px; border: 0px;' src='about:blank' scrolling='no' border=0 frameborder=0></iframe></div><div id='phplive_widget_embed_iframe_shadow' style='display: none; position: fixed; width: 515px; height: 538px; right: 0px; bottom: 0px; z-Index: 40000;'><img src='../themes/initiate/widget_shadow.png' width='515' height='538' border='0' alt=''></div>
