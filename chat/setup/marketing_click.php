...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<tr>
				...
				<td><div class="td_dept_header">Query key to append to URL <span class="info_neutral">example: <span style="color: #709EEC;">http://www.verypeachy.com/?</span><span class="txt_blue">&amp;plk=the query key</span></span></div></td>
			</tr>
			<?php
