...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div class="op_submenu_wrapper">
			...
			<div class="op_submenu" onClick="show_div('auto')" id="menu_code_auto">Automatic Chat Invite</div>
		...
		<div id="code_main" style="display: none; margin-top: 25px;">
			<div id="code_main_info" class="info_info">
				...
				<tr>
					...
					<td width="50%">
						...
						<div style="margin-top: 25px;" class="info_box">
							<form id="proto_pos">
			...
			<div id="div_html_code" style="margin-top: 25px; text-align: justify;">
				...
				<div style="" class="td_dept_td">
					...
					<!-- new version feature... still need finishing and optimzing <div style="margin-top: 15px; font-size: 10px;"><span id="department_add_btn" class="info_box" style="cursor: pointer;" onClick="open_departments(<?php echo $deptid ?>)"><img src="../pics/icons/add.png" width="12" height="12" border="0" alt=""> customize department selection</span></div> -->

					<div style="margin-top: 15px;"><textarea wrap="virtual" id="textarea_code_standard" style="font-size: 10px; padding: 20px; width: 930px; height: 120px; resize: none;" onMouseDown="setTimeout(function(){ $('#textarea_code_standard').select(); }, 200);" readonly></textarea></div>
				...
				<div style="" class="td_dept_td">
					...
					<?php else: ?>
						<div style="margin-top: 15px;"><textarea wrap="virtual" id="textarea_code_text" style="font-size: 10px; padding: 20px; width: 930px; height: 120px; resize: none;" onMouseDown="setTimeout(function(){ $('#textarea_code_text').select(); }, 200);" readonly></textarea></div>
			...
			<div style="margin-top: 25px;">
				...
				<tr>
					<td valign="top">
						...
						<div style="margin-top: 5px;"><img src="<?php echo Util_Upload_GetInitiate( $CONF["UPLOAD_HTTP"], 0 ) ; ?>" width="250" height="160" border="0" alt="" class="round"></div>
						...
						<div style="padding-left: 30px;">
							<div style="">
								...
								<tr>
									<td class="td_dept_td">
										<div>
											<select name="exin" id="exin">
												<option value="exclude" <?php echo ( isset( $initiate["exin"] ) && ( $initiate["exin"] == "exclude" ) ) ? "selected" : "" ; ?> >EXCLUDE automatic chat invite for URLs that contain:</option>
												<option value="include" <?php echo ( isset( $initiate["exin"] ) && ( $initiate["exin"] == "include" ) ) ? "selected" : "" ; ?>>INCLUDE automatic chat invite for only the URLs that contain:</option>
											</select>
										</div>
										<div style="margin-top: 5px; color: #5F7AAB;">
											* Provide the page itself and not the full URL. Example: <code>purchase.php, checkout.html, trial.asp</code><br>
