...
<?php include_once( "./inc_header.php" ) ?>
			...
			<div class="op_submenu_wrapper">
				<div class="op_submenu" onClick="location.href='settings.php?ses=<?php echo $ses ?>&jump=logo'" id="menu_logo">Logo</div>
				<div class="op_submenu" onClick="location.href='settings.php?ses=<?php echo $ses ?>&jump=themes'" id="menu_themes">Themes</div>
				<div class="op_submenu" onClick="location.href='settings.php?ses=<?php echo $ses ?>&jump=embed'" id="menu_embed">Chat</div>
				...
				<div class="op_submenu" onClick="location.href='settings.php?ses=<?php echo $ses ?>&jump=sips'" id="menu_sips">Block IPs</div>
				...
				<div style="float: left; border: 0px solid transparent; width: 258px; margin-right: 25px;">
					<div style="margin-top: 10px; overflow: auto;">
						...
						<?php
							...
							print "<tr><td></td><td><b>$approx_disc_use</b></td><td></td></tr>" ;
						?>
						</table>
					</div>
				</div>
