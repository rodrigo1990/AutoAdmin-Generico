<?php
					...
					$title )
	{
		...
		LIST( $deptid, $os, $browser, $ip, $vis_token, $onpage, $title, $url_mdfive ) = database_mysql_quote( $deptid, $os, $browser, $ip, $vis_token, $onpage, $title, $url_mdfive ) ;

		$query = "INSERT INTO p_footprints VALUES ( $now, '$ip', $os, $browser, '$vis_token', '$url_mdfive', '$onpage', '$title' )" ;
