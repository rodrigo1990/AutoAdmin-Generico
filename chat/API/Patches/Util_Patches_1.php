<?php
	...
	{ $patched = 21 ;
		...
		$query = "CREATE TABLE p_geo_loc ( locId int(10) unsigned NOT NULL, country char(2) $charset_string NOT NULL, region char(42) $charset_string NOT NULL, city varchar(50) $charset_string DEFAULT NULL, latitude float DEFAULT NULL, longitude float DEFAULT NULL, PRIMARY KEY (locId) )" ;
		database_mysql_query( $dbh, $query ) ;
	...
	{ $patched = 47 ;
		...
		if ( isset( $dbh["result"] ) && $dbh["result"] )
		{
			...
			$query = "CREATE TABLE p_socials ( deptID int(10) unsigned NOT NULL, status tinyint(1) NOT NULL, social varchar(15) $charset_string NOT NULL, tooltip varchar(55) $charset_string NOT NULL, url varchar(255) $charset_string NOT NULL, UNIQUE KEY deptID (deptID,social) )" ;
			database_mysql_query( $dbh, $query ) ;
	...
	{ $patched = 51 ;
		...
		$query = "ALTER TABLE p_marquees CHANGE snapshot snapshot VARCHAR( 80 ) $charset_string NOT NULL" ;
		database_mysql_query( $dbh, $query ) ;

		$query = "ALTER TABLE p_marquees CHANGE message message VARCHAR( 255 ) $charset_string NOT NULL" ;
		database_mysql_query( $dbh, $query ) ;
