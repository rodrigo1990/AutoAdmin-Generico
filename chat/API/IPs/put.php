<?php
	...
	FUNCTION IPs_put_IP( &$dbh, $ip, $vis_token, $deptid, $t_footprints, $t_requests, $t_initiate, $request, $initiate, $i_footprints, $i_timestamp, $onpage = "" )
	{
		...
		LIST( $vis_token, $t_footprints, $t_requests, $t_initiate, $i_footprints, $i_timestamp ) = database_mysql_quote( $vis_token, $t_footprints, $t_requests, $t_initiate, $i_footprints, $i_timestamp ) ;
		if ( isset( $ipinfo["ip"] ) )
