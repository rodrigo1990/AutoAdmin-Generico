<?php
					...
					$plain )
	{
		...
		LIST( $ces, $status, $created, $ended, $deptid, $opid, $initiated, $op2op, $rating, $fsize, $vname, $vemail, $ip, $vis_token, $question, $formatted, $plain ) = database_mysql_quote( $ces, $status, $created, $ended, $deptid, $opid, $initiated, $op2op, $rating, $fsize, $vname, $vemail, $ip, $vis_token, $question, $formatted, $plain ) ;
