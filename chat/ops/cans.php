...
<?php include_once( "./inc_header.php" ) ; ?>
		...
		<div id="no_dept" class="info_error"><img src="../pics/icons/warning.png" width="12" height="12" border="0" alt=""> Contact the setup admin to assign this account to a department.  Once assigned, refresh this page to continue.</div>
		<?php else: ?>
		<div id="div_cans">
			<a name="a_top"></a>
			<div id="cans" style="">
