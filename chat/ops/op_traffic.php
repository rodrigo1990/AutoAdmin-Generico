...
<!--
	...
	function populate_traffic()
	{
		...
		if ( parent.extra == "traffic" )
		{
			...
			success: function(data){
				...
				{
					var vis_exist = 0 ;
					var td_geoip = ( <?php echo $geoip ?> ) ? "<td width=\"50\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">&nbsp;</div></td>" : "" ;
					var td_ip = ( parent.viewip ) ? "<td width=\"90\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">IP</div></td>" : "" ;
					var traffic_string = "<table cellspacing=0 cellpadding=0 border=0 width=\"100%\" id=\"table_trs_traffic\"><tr><td width=\"45\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">&nbsp;</div></td><td width=\"80\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">Duration</div></td><td width=\"80\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">Campaign</div></td>"+td_geoip+td_ip+"<td width=\"90\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">Platform</div></td><td width=\"45\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">t-f</div></td><td width=\"45\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">t-c</div></td><td width=\"45\"><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">t-i</div></td><td><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">On Page</div></td><td nowrap><div class=\"chat_info_td_t noround\" style=\"margin-right: 0px;\">Refer</div></td></tr>" ;
		...
		success: function(data){
			...
			if ( json_data.status )
			{
				...
				for ( c = 0; c < json_data.footprints.length; ++c )
				{
					...
					footprints_string += "<tr><td width=\"30\" style=\"text-align: center\" class=\"chat_info_td\"><b>"+json_data.footprints[c]["total"]+"</b></td><td width=\"100%\" class=\"chat_info_td\"><div title=\""+json_data.footprints[c]["onpage"]+"\" alt=\""+json_data.footprints[c]["onpage"]+"\"><a href=\""+url_raw+"\" target=\"_blank\">"+json_data.footprints[c]["title"]+"</a></div></td></tr>" ;
				}
	...
	function populate_requestinfo( theip, thevis_token, thecountry, theregion, thecity )
	{
		...
		success: function(data){
			...
			if ( json_data.status )
			{
				$('#info_duration').empty().html( " <span class=\"info_good\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/info_chats.gif\" width=\"10\" height=\"10\" border=\"0\" alt=\"\" style=\"cursor: pointer;\" title=\"currently in a chat session with "+json_data.name+"\" alt=\"currently in a chat session with "+json_data.name+"\"></span>" ) ;
			}
	...
	{
		parent.vis_token = this.undefined ;
	...
	function populate_transcripts( thevis_token )
	{
		...
		success: function(data){
			...
			if ( json_data.status )
			{
				...
				{
					transcripts_string += "<tr><td class=\"chat_info_td_traffic\" width=\"16\" id=\"img_"+json_data.transcripts[c]["ces"]+"\" style=\"cursor: pointer; -moz-border-radius: 5px; border-radius: 5px;\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/view.png\" onClick=\"parent.open_transcript('"+json_data.transcripts[c]["ces"]+"')\" width=\"16\" height=\"16\" title=\"view transcript\" alt=\"view transcript\"></td><td class=\"chat_info_td_traffic\"><b>"+json_data.transcripts[c]["operator"]+"</b></td><td class=\"chat_info_td_traffic\">"+json_data.transcripts[c]["vname"]+"</td><td class=\"chat_info_td_traffic\">rating</td><td class=\"chat_info_td_traffic\" nowrap>"+json_data.transcripts[c]["created"]+"</td><td class=\"chat_info_td_traffic\" nowrap>"+json_data.transcripts[c]["duration"]+"</td><td class=\"chat_info_td_traffic\">"+json_data.transcripts[c]["question"]+"</td></tr>" ;
				}
...
<div id="canned_wrapper" style="display: none; height: 100%; overflow: auto;">
	...
	<tr>
		<td class="t_ml"></td><td class="t_mm">
			<div class="chat_info_td_t" style="font-size: 10px; text-align: right; margin-right: 0px;"><span id="div_reference">t-f = Total Footprints, t-c = Total Chat Requests, t-i = Total Operator Initiated Chat</span></div>
	...
	<tr>
		<td class="t_ml"></td><td class="t_mm">
			...
			<div style="margin-top: 15px;">
				...
				<div id="menu_traffic_info_trans" class="menu_traffic_info" onClick="toggle_menu_info('trans')">Past Transcripts (<span id="info_trans"></span>)</div>
			...
			<div id="div_traffic_info_info" style="margin-top: 15px;">
				...
				<tr>
					...
					<td valign="top" width="70%">
						<table cellspacing=0 cellpadding=0 border=0 width="100%">
						<tr>
							<td class="chat_info_td_traffic" width="100">Visitor ID</td>
			...
			<div id="div_traffic_info_initiate" style="display: none; margin-top: 15px; overflow: auto;">
				...
				<tr>
					<td valign="top">
						...
						<div style="margin-top: 5px;"><textarea id="chat_info_initiate_message" class="input_text" cols="40" rows="4" wrap="virtual" style="resize: none;"></textarea></div>
						<div style="margin-top: 5px; font-size: 10px;">* brief message (recommended: 25 words or fewer)</div>
					</td>
					<td valign="top" style="padding-left: 15px;">
						<div style="">
							<div>or Canned Response:</div>
						...
						<div style="margin-top: 25px;"><button type="button" onClick="initiate_chat()" id="btn_initiate">Initiate Chat</button></div>
					</td>
				</tr>
				</table>
				</form>
