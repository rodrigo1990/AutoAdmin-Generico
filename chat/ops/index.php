...
<!--
	...
	function update_password()
	{
		...
		{
			$('#cpass').val( phplive_md5( phplive_md5( $('#cpass').val() )+$.cookie("phplive_token") ) ) ;
			$('#npass').val( phplive_md5( $('#npass').val() ) ) ;
			$('#vnpass').val( phplive_md5( $('#npass').val()+$.cookie("phplive_token") ) ) ;
			$('#theform').submit() ;
		}
	}
...
<?php include_once( "./inc_header.php" ); ?>
		...
		<div id="op_go" style="margin: 0 auto;">
			<div id="no_dept" class="info_error" style="display: none;"><img src="../pics/icons/warning.png" width="12" height="12" border="0" alt=""> Contact the setup admin to assign this account to a department.  Once assigned, refresh this page to continue.</div>
						...
						<tr>
							<td width="60%" valign="top">
								...
								<div style="margin-top: 15px;">
									...
									<tr>
										<td><span style="font-size: 10px;">mobile #</span><br><input type="text" class="input" size="15" maxlength="25" id="phonenum" name="phonenum" onKeyPress="return numbersonly(event)" value="<?php echo isset( $smsnum[0] ) ? $smsnum[0] : "" ?>"></td>
									...
									<tr>
										<td colspan=3>
											<div style="margin-top: 15px;">Verification of your mobile devide is required.  There will be a 1 minute delay between each verification attempts.  If you do not receive the verification code within 5-10 minutes, double check the mobile number and the carrier values for accuracy . <span id="sma_reset" style="display: none; text-decoration: underline; cursor: pointer;" onClick="reset_mobile()">To clear and reset the SMS information, click here.</span></div>
										</td>
									</tr>
									</table>
								</div>
			...
			<tr>
				<td>
					...
					<div id="dn_firefox" style="display: none;">
						...
						<div style="margin-top: 15px;">However, the system has detected a Firefox browser.  There is a Firefox desktop notification addon but the addon has since been discontinued on November 2013.  A new version of Firefox is currently being developed that includes a built-in desktop notification.  When the new Firefox version is released and installed, check back to this page to enable the notification.  If you are seeing this message, then the Firefox version currently installed does have a built-in desktop notification.  Let's hope a new Firefox version will be available very soon.</div>
					</div>
		...
		<div id="op_password" style="display: none; margin: 0 auto;">
			...
			<div style="">
				...
				<input type="password" class="input" name="cpass" id="cpass" size="30" maxlength="50" value="">
				
				<div style="margin-top: 15px;">New Password</div>
				<input type="password" class="input" name="npass" id="npass" size="30" maxlength="50" value=""><div style="font-size: 10px;">* letters and numbers</div>
				
				<div style="margin-top: 15px;">Verify New Password</div>
				<input type="password" class="input" name="vnpass" id="vnpass" size="30" maxlength="50" value=""><div style="font-size: 10px;">* letters and numbers</div>
