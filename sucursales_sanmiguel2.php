  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/sanmiguel2.jpg" alt="SAN MIGUEL 2" class="img_full" />
                <span>SAN MIGUEL 2</span><br />
                Presidente Perón 1185
                <br /><br />
                <b>TEL:</b> 4664-4449<br />
                <b>Whatsapp:</b> 15 3252 3061
                <br /><br />
                Lunes a Viernes de 9 a 13 y 15 a 19:00hs.<br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.545593, lng: -58.707374};
