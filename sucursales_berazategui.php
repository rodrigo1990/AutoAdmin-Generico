  ...
  <div class="row" id="sucursales_sec">
      ...
      <div class="col-sm-3">
       <div class="item_sucursal">
                <img src="imagenes/sucursales/berazategui.jpg" alt="BERAZATEGUI" class="img_full" />
                <span>BERAZATEGUI</span><br />
                Av. 14 Nº5022
                <br /><br />
                <b>TEL:</b> 4356-0717 / 0911<br />
                <b>Whatsapp:</b> 15 3252 4896
                <br /><br />
...
<script>
  function initMap() {
    var uluru = {lat: -34.760503, lng: -58.206957};
